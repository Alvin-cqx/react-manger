 ...
 * @LastEditors: 陈庆贤
 * @LastEditTime: 2023-11-24 16:32:59
 * @Description
 */

// ahooks  useAntdTable版本 封装前
import { User, FormItem } from '@/types/api'
import { Button, Table, Form, Input, Select, Space, Popconfirm, message, Modal, FormInstance } from 'antd'
...
export default function UserList() {
  ...
  useEffect(() => {
    console.log(myformRef.current?.getFieldsForm, 'ssad')
  }, [myformRef.current?.getFieldsForm])
    ...
    <div className='user-list'>
      ...
      <CreateUser
        ...
        update={() => {
          ...
          // }),
          // 停留在当前页
          run({ current: tableProps.pagination.current, pageSize: 10 }, form.getFieldsValue())
          setSelectedRowKeys([])
        }}
      />
    </div>
