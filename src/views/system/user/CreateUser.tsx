 ...
 * @Description:
 */
import { Modal, Form, Input, Select, Upload, App, TreeSelect } from 'antd'
...
import { userCreate, userEdit, getDeptList, getRoleAllList } from '@/api/api'
...
export const CreateUser = (props: IModalProps) => {
  ...
  // 获取所有角色
  const getRoleAllListData = async () => {
